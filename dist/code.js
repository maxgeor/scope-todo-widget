    ...
    const Todo = (todo) => {
        ...
        return (figma.widget.h(AutoLayout, { key: id, direction: "horizontal", verticalAlignItems: "start", spacing: "auto", width: "fill-parent" },
            ...
            ` }),
                ...
                figma.widget.h(Input, { fill: outOfScope ? "#6E6E6E" : done ? "#767676" : "#101010", fontSize: done || outOfScope ? 13 : 14, lineHeight: 20, width: 240, value: title, placeholder: "I need to...", onTextEditEnd: (e) => {
                        e.characters === ""
                            ? deleteTodo(id)
